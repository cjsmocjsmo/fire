...
async fn alienworlds(path: web::Path<String>) -> impl Responder  {
...
async fn alteredcarbon(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn andor(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn badbatch(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn blackknight(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn bobbafett(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn cowboybebop(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn discovery(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn enterprise(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn forallmankind(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn foundations(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn hford1923(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn houseofthedragon(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn lostinspace(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn lowerdecks(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn mandalorian(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn nextgeneration(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn nightsky(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn obiwan(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn orville(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn picard(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn prodigy(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn raisedbywolves(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn reacher(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
    // println!("{:?}", season);
...
async fn ringsofpower(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn strangenewworlds(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn talesofthejedi(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn thelastofus(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn visions(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn voyager(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
...
async fn wheeloftime(path: web::Path<String>) -> impl Responder  {
    let season = path.into_inner();
